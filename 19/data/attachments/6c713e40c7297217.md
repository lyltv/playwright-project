...
Locator:  getByText('Nhận phòng').locator('..').getByText('10-07-2026')
Expected: hidden
Received: visible
Timeout:  3000ms
...
Call log:
  ...
  - waiting for getByText('Nhận phòng').locator('..').getByText('10-07-2026')
    9 × locator resolved to <div>10-07-2026</div>
