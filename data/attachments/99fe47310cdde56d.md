...
- Name: homepage/search.spec.ts >> Search >> SEARCH_04: Chọn ngày trên trang chủ → search bar cập nhật đúng ngày đã chọn
- Location: tests/homepage/search.spec.ts:69:9
