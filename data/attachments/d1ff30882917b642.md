...
Locator:  getByText('Nhận phòng').locator('..').getByText('09-07-2026')
Expected: hidden
Received: visible
Timeout:  3000ms
...
Call log:
  ...
  - waiting for getByText('Nhận phòng').locator('..').getByText('09-07-2026')
    10 × locator resolved to <div>09-07-2026</div>
