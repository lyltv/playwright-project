...
Call log:
  ...
  - waiting for getByRole('dialog')
    5 × locator resolved to <div role="dialog" aria-modal="true" class="ant-modal css-zl9ks2 ant-zoom-appear ant-zoom-appear-active ant-zoom">…</div>
      - unexpected value "visible"
    19 × locator resolved to <div role="dialog" aria-modal="true" class="ant-modal css-zl9ks2">…</div>
       - unexpected value "visible"
