...
- Name: booking/room-detail.spec.ts >> Room Detail >> ROOM_05: Click ảnh → gallery mở, điều hướng next/prev, đóng gallery
- Location: tests/booking/room-detail.spec.ts:165:9
...
Call log:
  - waiting for locator('.ant-image').first()
    - locator resolved to <div class="ant-image css-zl9ks2">…</div>
