...
- Name: homepage/search.spec.ts >> Search >> SEARCH_01: Tìm kiếm theo địa điểm từ trang chủ → hiển thị kết quả đúng location
- Location: tests/homepage/search.spec.ts:5:9
