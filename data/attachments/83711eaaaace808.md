...
- Name: homepage/search.spec.ts >> Search >> SEARCH_05: Chọn ngày trên trang kết quả → date picker hoạt động bình thường
- Location: tests/homepage/search.spec.ts:99:9
