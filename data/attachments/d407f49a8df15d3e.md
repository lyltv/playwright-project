...
```ts
  36  |     test.skip('SEARCH_FILTER_04: Should reject end date before start date', async ({ page }) => {
  37  |         await page.goto('/');
  ...
  83  |     });
  84  | 
  85  |     test.skip('SEARCH_FILTER_07: Should handle excessive guest count', async ({ page }) => {
  86  |         await page.goto('/');
  87  | 
