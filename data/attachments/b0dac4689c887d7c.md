...
- Name: dashboard/booked.spec.ts >> Dashboard - Booked Rooms >> BOOKED_02: Should show message when no rooms rented
- Location: tests/dashboard/booked.spec.ts:42:9

# Error details

```
Error: page.goto: net::ERR_NAME_NOT_RESOLVED at https://demo5.cybersoft.edu.vn/
Call log:
