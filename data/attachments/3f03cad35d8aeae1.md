...
Locator: getByRole('navigation').locator('span').filter({ hasText: /Ly Le Thi Van/ }).first()
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByRole('navigation').locator('span').filter({ hasText: /Ly Le Thi Van/ }).first()
