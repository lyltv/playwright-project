...
- Name: homepage/search.spec.ts >> Search >> SEARCH_02: Tìm kiếm theo địa điểm khác từ trang kết quả → chuyển sang location mới
- Location: tests/homepage/search.spec.ts:20:9
