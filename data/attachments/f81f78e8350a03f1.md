...
- Name: homepage/search.spec.ts >> Search >> SEARCH_06: Vào room detail → booking modal giữ lại ngày, số khách đã chọn trước đó
- Location: tests/homepage/search.spec.ts:119:9
