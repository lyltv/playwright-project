...
Call log:
  ...
  - waiting for getByRole('dialog')
    4 × locator resolved to <div role="dialog" aria-modal="true" class="ant-modal css-zl9ks2 ant-zoom-appear ant-zoom-appear-active ant-zoom">…</div>
      - unexpected value "visible"
    20 × locator resolved to <div role="dialog" aria-modal="true" class="ant-modal css-zl9ks2">…</div>
       - unexpected value "visible"
