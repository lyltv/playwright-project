...
- Name: homepage/register.spec.ts >> CyberBnB Register >> Should toggle password visibility with eye icon
- Location: tests/homepage/register.spec.ts:272:9
...
Call log:
  - waiting for getByRole('dialog').locator('.ant-input-password-icon')
            ...
            - generic [ref=e233]:
              ...
              - generic [ref=e235]:
                ...
                - generic [ref=e255]:
                  ...
                  - generic [ref=e262]:
                    - textbox "Password" [active] [ref=e263]:
